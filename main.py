...
img1 = face_recognition.load_image_file('images/jeeva.jpg')
img1 = cv2.cvtColor(img1, cv2.COLOR_BGR2RGB)

img1Test = face_recognition.load_image_file('images/jeeva.jpg')
...
cv2.imshow('prabu', img1)
cv2.imshow('prabu Test', img1Test)
cv2.waitKey(0)
